    ...
    public class MainController
    {
        ...
        private void HandleMenuEvent(ref MenuEvent pVal, out bool bubbleEvent)
        {
            ...
            if (pVal.MenuUID.Equals("FrmGeraOS") && !pVal.BeforeAction)
            {
                try
                {
                    string srfPath = System.Environment.CurrentDirectory + "\\SrfFiles\\FrmGeraOS.srf";
...
//#endif
            ...
            if (pVal.MenuUID.Equals("FrmCnfIntegraBalanca") && !pVal.BeforeAction)
            {
                try
                {
                    string srfPath = System.Environment.CurrentDirectory + "\\SrfFiles\\FrmCnfIntegraBalanca.srf";
        ...
        public static void OpenNotasGeradasView(List<int> notas)
        {
            try
            {
                ...
                string srfPath = System.Environment.CurrentDirectory + "\\SrfFiles\\FrmNotasGeradas.srf";
